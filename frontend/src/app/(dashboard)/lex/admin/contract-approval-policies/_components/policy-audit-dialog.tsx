...
/**
 * Append-only audit-trail dialog for a contract approval policy.
 *
 * Reads `enterpriseApi.lex.listApprovalPolicyAudit(id)`. Mirrors the request-side
 * `PolicyAuditDialog`.
 */
...
export function PolicyAuditDialog({
  ...
  const auditQuery = useQuery({
    queryKey: ['lex-contract-approval-policy-audit', policyId],
    queryFn: () => enterpriseApi.lex.listApprovalPolicyAudit(policyId),
